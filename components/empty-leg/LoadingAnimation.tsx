  ...
  const items = [
    {
      ...
      description: "Analyzing available empty leg paths...",
      icon: "🛫",
    },
    {
      key: "availability",
      title: "Checking Jet Availability",
      description: "Reviewing active empty leg flights...",
      icon: "🛩️",
    },
    {
      key: "pricing",
      title: "Calculating Discounted Prices",
      description: "Applying empty leg savings and best deals...",
      icon: "💸",
    },
    {
      key: "jets",
      title: "Matching Empty Leg Jets",
      description: "Selecting the best aircraft for your route...",
      icon: "✈️",
    },
    {
      key: "complete",
      title: "Results Ready",
      description: "Your empty leg flight options are prepared",
      icon: "🔍",
    },
  ];
